...
const About = () => {
  return (
    <section className='bg-[#92dffe] flex justify-center py-5'>
      <div className="container px-5 lg:px-0 flex flex-col gap-12 lg:gap-24">
        {/* heading */}
        <h2
          className='grandstander text-center text-4xl lg:text-6xl font-bold text-white uppercase'
        >
        ...
        {/* text */}
        <p className='grandstander text-start text-3xl lg:text-7xl font-semibold tracking-wide text-white uppercase'>
